  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion"style="background-color: #008000;" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" style="color:white;">
        ...
        <div class="sidebar-brand-text mx-3">Tanaman Hias</div>
      </a>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('toko/merk/merk_tanaman')?>">
        <i class="fas fa-spa"></i>
          <span>Produk</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('toko/tentang')?>">
