  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" >
      <div class="carousel-item active">
        <img src="<?php echo base_url('assets/img/bg1.jpg') ?>" class="d-block w-100" alt="..." style="height:400px">
      </div>
      <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/bg2.jpg') ?>" class="d-block w-100" alt="..." style="height:400px">
      </div>
      <div class="carousel-item">
        <img src="<?php echo base_url('assets/img/bg3.jpg') ?>" class="d-block w-100" alt="..." style="height:400px">
      </div>
      ...
      <div class="card ml-3 mb-3" style="width: 18rem; ">
       <center><img src="<?php echo base_url().'/gambar/'.$prd->gambar ?>" class="card-img-top" alt="..." style="height:200px; width:200px"></center> 
        ...
        <span class="badge badge-pill badge-success mb-2">Rp. <?php echo number_format($prd->harga,0,',','.')?> </span></p>
          ...
          <?php echo anchor('toko/dashboard/tambah_keranjang_tanaman/'.$prd->id_brg,'<div class="btn btn-sm btn-primary">Tambah ke Keranjang</div>')?>
